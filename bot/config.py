...
def load_config(
  *,
  ...
  """Resolve CLI and environment settings into immutable runtime configuration.

  Token priority is explicit value, generic variable, environment-specific
  variable, then token file.
  """
