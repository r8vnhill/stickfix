...
The historical logger name is retained so existing operational filters keep
working after the package namespace changes.
"""
...
from ..errors import MissingStickerError
from ..requests import DeleteStickerCommand
from ..results import DeleteStickerResult
from ._base import StickerPackUseCase
from ._repositories import resolve_effective_user, save_effective_pack

logger = logging.getLogger("bot.application.use_cases.delete_sticker")
