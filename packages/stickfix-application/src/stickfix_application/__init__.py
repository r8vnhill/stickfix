...
This module re-exports commonly used application errors, DTOs, and selected
results so callers can import from one stable namespace when needed.

## Contract:

- keep exports Telegram-free (validated by seam tests that import ``stickfix_application``)
